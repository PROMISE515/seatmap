...
const translations = {
  en: {
    ...
    "home.inviteSuccessDescription": "Your SeatMap Travel Pass is active on this device.",
    ...
    "city.noCuratedTitle": (city) => `Live SeatMap search is available in ${city}`,
  ...
  es: {
    ...
    "home.inviteSuccessDescription": "Tu pase de SeatMap está activo en este dispositivo.",
    ...
    "city.noCuratedTitle": (city) => `La búsqueda en vivo de SeatMap está disponible en ${city}`,
    "city.noCuratedBody": (city) =>
