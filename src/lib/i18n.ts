...
const translations = {
  en: {
    ...
    "home.searchRadius": "Search 1 km radius",
    ...
    "home.checkingCity": "Checking your current city",
    ...
    "home.serviceNotOpen": "Service not open here",
    "home.readyWhen": "Ready when you are",
    "home.sortedByDistance": "Sorted by distance",
    "home.noToilets": "No toilets found within 1 km. Try moving and searching again.",
    "home.unsupported": (region, supported) =>
      `${region} is not open yet. Current opened cities: ${supported}.`,
    ...
    "home.paywallDescription":
      "Your free emergency search is used. Unlock unlimited live toilet searches for your trip.",
    ...
    "card.likelyWestern": "Likely Western",
    ...
    "city.previewExplain": (city) =>
      `These are ${city} city-area results, not distances from your current location. Navigation is disabled here to avoid sending you to the wrong city.`,
    "city.travelerTip": "Traveler tip",
    "city.neighborhoods": "Best neighborhoods to find one",
    "city.loading": "Loading...",
    "city.liveLocations": (count) => `${count} live locations`,
    "city.liveFromAmap": "Live from AMap",
    "city.noPublic": (city) => `No public toilets found in ${city}.`,
    "city.whyUse": (city) => `Why use SeatMap in ${city}?`,
    "city.reason1": "Live listings are screened for seated-toilet likelihood",
  ...
  es: {
    ...
    "home.searchRadius": "Buscar en radio de 1 km",
    ...
    "home.checkingCity": "Comprobando tu ciudad actual",
    ...
    "home.serviceNotOpen": "Servicio no abierto aquí",
    "home.readyWhen": "Listo cuando quieras",
    "home.sortedByDistance": "Ordenado por distancia",
    "home.noToilets": "No se encontraron baños en 1 km. Muévete un poco e intenta otra vez.",
    "home.unsupported": (region, supported) =>
      `${region} todavía no está abierto. Ciudades abiertas: ${supported}.`,
    ...
    "home.paywallDescription":
      "Ya usaste tu búsqueda gratis de emergencia. Desbloquea búsquedas ilimitadas para tu viaje.",
    ...
    "card.likelyWestern": "Probable inodoro occidental",
    ...
    "city.previewExplain": (city) =>
      `Estos son resultados del área de ${city}, no distancias desde tu ubicación actual. La navegación está desactivada para evitar enviarte a otra ciudad.`,
    "city.travelerTip": "Consejo para viajeros",
    "city.neighborhoods": "Mejores zonas para encontrar uno",
    "city.loading": "Cargando...",
    "city.liveLocations": (count) => `${count} ubicaciones en vivo`,
    "city.liveFromAmap": "En vivo desde AMap",
    "city.noPublic": (city) => `No se encontraron baños públicos en ${city}.`,
    "city.whyUse": (city) => `Por qué usar SeatMap en ${city}`,
    "city.reason1": "Los resultados se filtran por probabilidad de inodoro sentado",
