...
const translations = {
  en: {
    ...
    "home.searchRadius": "",
    "home.shareTitle": "Western Toilet Map",
    "home.shareText": "Open my Western Toilet Map invite link.",
    ...
    "home.paywallTitle": "Western Toilet Map Travel Pass",
    ...
    "home.best": "Best",
    "home.inviteTitle": "Have an invite code?",
    "home.inviteDescription": "Redeem a creator or traveler invite for free access.",
    "home.invitePlaceholder": "Enter invite code",
    ...
    "home.shareExplain":
      "Send Western Toilet Map to a friend. When they open your link, you get one extra free search.",
    ...
    "city.liveSearchCta": "Search live toilets near me",
    ...
    "city.liveFromAmap": "Curated preview list",
    "city.noPublic": (city) => `No public toilets found in ${city}.`,
    "city.noCuratedTitle": (city) => `Live Western Toilet Map search is available in ${city}`,
    "city.noCuratedBody": (city) =>
      `We have not published a fixed preview list for ${city} yet. Use the home search to pull nearby seated-toilet candidates from AMap based on your current location.`,
    "city.whyUse": (city) => `Why use Western Toilet Map in ${city}?`,
  ...
  es: {
    ...
    "home.searchRadius": "",
    "home.shareTitle": "Western Toilet Map",
    "home.shareText": "Abre mi enlace de invitación de Western Toilet Map.",
    ...
    "home.paywallTitle": "Pase de viaje Western Toilet Map",
    "home.paywallDescription":
    ...
    "home.best": "Mejor",
    "home.inviteTitle": "¿Tienes un código de invitación?",
    "home.inviteDescription": "Canjea una invitación de creador o viajero para acceso gratis.",
    "home.invitePlaceholder": "Ingresa el código",
    ...
    "home.shareExplain":
      "Envía Western Toilet Map a un amigo. Cuando abra tu enlace, tú recibes una búsqueda gratis extra.",
    ...
    "city.liveSearchCta": "Buscar baños cerca de mí",
    ...
    "city.footer": (city) =>
      `Western Toilet Map · Encuentra un baño con inodoro en ${city} en menos de 10 segundos.`,
  },
